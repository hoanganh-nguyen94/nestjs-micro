...
kubectl apply -n demo -f kubernetes/servicemesh/applications/playlists-api/
kubectl apply -n demo -f kubernetes/servicemesh/applications/playlists-db/
kubectl apply -n demo -f kubernetes/servicemesh/applications/videos-api/
kubectl apply -n demo -f kubernetes/servicemesh/applications/videos-web/
kubectl apply -n demo -f kubernetes/servicemesh/applications/videos-db/
...
While ($true) { curl -UseBasicParsing http://servicemesh.demo/api/playlists; Start-Sleep -Seconds 5;}
While ($true) { curl -UseBasicParsing http://servicemesh.demo/home/; Start-Sleep -Seconds 10;}
```
